...
public class Defect_07 extends Signature {
	...
	public Defect_07() {
		...
		instructions
				.add("In the Histogram, search for <strong>CdsEncounter</strong>.");
		instructions
				.add("Enter the object count into the <em>CdsEncounter Objects</em> field.");
		instructions
				.add("Right click on the CdsEncounter class and select \"Merge Shortest Path to GC roots with all references.\"");
		instructions
				.add("Identify a thread root named with this syntax: pool-NN-thread-Y (ex. pool-27-thread-2). Right-click on it and select Java Basics -> Thread Details.");
		instructions
				.add("Determine if com.patientkeeper.recurringtask.providerpopulator.ProviderCachePopulatorTask.run() exists in the Thread details.");
		instructions
				.add("Update the <em>ProviderCachePopulatorTask.run()</em> field appropriately.");
